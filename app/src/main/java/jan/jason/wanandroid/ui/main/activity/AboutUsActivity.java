...
import jan.jason.wanandroid.base.activity.AbstractSimpleActivity;
import jan.jason.wanandroid.utils.StatusBarUtil;
import jan.jason.wanandroid.widget.interpolator.ElasticOutInterpolator;
...
public class AboutUsActivity extends AbstractSimpleActivity {
    ...
    private void setSmartRefreshLayout() {
        ...
        //设置让Toolbar和AppBarLayout的滚动同步 意思就是说下拉后，标题栏要消失，或者标题也要随之下降
